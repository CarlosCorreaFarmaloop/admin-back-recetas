...
import {
  ...
  ResumeOrder,
  Tracking,
} from '../../core/modules/orden/domain/orden.entity';
...
const DeliverySchema = new mongoose.Schema<Delivery>(
  {
    ...
    tags: { type: Map, of: Schema.Types.Mixed, required: false },
  },
  { _id: false }
);
...
export const OrdenModel = model<OrdenEntity>('orders', OrdenSchema);
